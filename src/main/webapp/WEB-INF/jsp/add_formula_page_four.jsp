            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${raws}" var="raws">
                        <tr>
                            <form action="/add_formula_page_five" method="POST">
                                <td>${raws.id}</td>
                                <td>${raws.name}</td>
                                ...
                                <input hidden name="ingredient3" value="${ingredient3}">
                                <input hidden name="rowFourId" value="${raws.id}">
                    ...
                    <h3>${measure}</h3>
                    <h3>Ingredient:</h3>
                    <h3>${ingredient1.raw.name}
                        (${ingredient1.weight}),
                        ${ingredient2.raw.name}
                        (${ingredient2.weight}),
                        ${ingredient3.raw.name}
                       (${ingredient3.weight})
                        </h3>
